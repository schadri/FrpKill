      ...
      <div className={styles.container}>
        <div className={styles.aboutSection}>
          ...
          <p className={styles.text}>
            No somos distribuidores oficiales, pero facilitamos la adquisición de licencias y créditos para toda Argentina de forma directa, rápida y totalmente segura.
          </p>
        </div>
        ...
        <div className={styles.contactSection}>
          ...
          <p className={styles.text}>
            Si tenes alguna duda o necesitas un soporte más personalizado, ¡no hay problema! Contáctanos vía WhatsApp y te asistiremos de inmediato.
          </p>
          <a 
          ...
          >
            ...
            WhatsApp +54 9 11 2335-1610
          </a>
        </div>
      </div>
      <div className={styles.bottomBar}>
        <p>&copy; {new Date().getFullYear()} FRP KILL. Todos los derechos reservados.</p>
      </div>
    </footer>
  );
}
